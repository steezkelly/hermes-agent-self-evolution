...
Use xiaomi/mimo-v2.5 for delegation (not pro - 2x cost for "little gain").
Minimax API returned 400 "Not supported model" on 2026-04-25 — mimo-v2.5 works as fallback.
Steve's preference: mimo-v2.5 for all delegation unless pro is specifically needed.
