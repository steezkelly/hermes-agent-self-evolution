...
description: Search arXiv for papers matching a research query using arXiv CLI
version: 0.1.0-seed
metadata:
  hermes:
    tags: [seed-generated]
    generation:
      seed: "Search arXiv for papers matching a research query using arXiv CLI"
...
Search arXiv for papers matching a research query using arXiv CLI
